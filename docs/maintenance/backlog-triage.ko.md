...
이 문서는 2026-03-20 기준으로 열려 있는 GitHub PR 1개, 이슈 30개를 유지보수 재가동 관점에서 다시 묶은 결과다.  
...
| 오픈 이슈 | 30 | 표면상 30개지만, 실제 작업 묶음은 대략 10~15개 수준으로 수렴한다 |
...
| 이슈 `#529`, `#706`, `#717`, `#710`, `#582`, `#491`, `#158`, `#162` | 닫음 | 현재 유지보수 스코프를 넘는 재작성/고급 기능 요청이거나 내용이 너무 약해 baseline 유지보수 백로그로 가져가기 어려움 |
